...
Konstanta Class atau **Class Constants** dapat juga didefinisikan di dalam sebuah *Class* dan sama seperti <a href="https://khoerodin.id/constanta-dalam-php/" target="_blank">konstanta regular</a> konstanta *class* juga tidak dapat diubah nilainya. Nilai atau *value* dari konstanta harus berupa *ekspresi konstan* yaitu bukan merupakan *variable*, *property* atau *function* dan lain-lain.
